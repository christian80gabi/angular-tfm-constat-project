...
CREATE TABLE `insurance` (
  `id_insurance` int(10) NOT NULL AUTO_INCREMENT,
  `name_insurance` varchar(50) DEFAULT NULL,
  `insurance_policy` int(80) DEFAULT NULL,
  ...
  KEY `fk_insured3` (`insured`),
  CONSTRAINT `fk_insured3` FOREIGN KEY (`insured`) REFERENCES `insured` (`id_insured`)
