...
CREATE TABLE `witness` (
  `id_witness` int(10) NOT NULL AUTO_INCREMENT,
  `name_witness` varchar(100) DEFAULT NULL,
  `address_witness` varchar(80) DEFAULT NULL,
  `tel_witness` int(15) DEFAULT NULL,
  `report` int(10) DEFAULT NULL,
  PRIMARY KEY (`id_witness`),
  KEY `fk_report` (`report`),
  CONSTRAINT `fk_report` FOREIGN KEY (`report`) REFERENCES `report` (`id_report`)
...
-- Dump completed on 2019-06-24 16:04:07
